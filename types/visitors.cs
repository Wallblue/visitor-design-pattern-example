...
public abstract class Visitor()
{
  ...
  public abstract void VisitSwimmingPool(SwimmingPool swimmingPool);
}

public class InsuranceVisitor : Visitor
{
  ...
  public override void VisitMuseum(Museum museum)
  {
    ...
    Console.WriteLine($"Your art collection is enormous, { museum.artCollection.Count } pieces of art ! {museum.artCollection[1]} is such a masterclass.");
    Console.WriteLine($"Our insurance for heritage protection would suit your affair perfectly.");
    this.IncrementVisitNumber();
  }

  public override void VisitSwimmingPool(SwimmingPool swimmingPool)
  {
